...
const Otros = () => {
    ...
    const otros = empresas.filter(empresa => (empresa.rubro === "otros")).sort((a, b) => a.titulo.localeCompare(b.titulo));
    return (
        <div id='otros'>
            {otros.length >= 1 ? 
                <div className='flex flex-col bg-amber-50'>
                    ...
                    <h3 className='text-3xl lg:text-4xl font-bold text-center mt-2 mb-6 font-titulos'>Otros Servicios</h3> 
                    <div className="flex justify-center gap-4 mb-2 flex-wrap px-2 pb-10">
                        <div className="flex justify-center gap-4 flex-wrap">
                            {otros.slice(0, ver).map((empresa) => (

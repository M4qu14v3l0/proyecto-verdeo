...
const Nosotros = () => {
    return (
        <div className="w-screen flex flex-col mt-6">z
            ...
            <Link className="flex bg-nos bg-cover bg-no-repeat bg-center h-80" href="/nosotros">
                <div className="flex-flex-col p-4 mt-auto">
                    <h4 className="text-center text-xl font-bold mb-5 text-white">Nuestro Equipo</h4>

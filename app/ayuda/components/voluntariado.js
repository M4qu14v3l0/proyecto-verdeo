...
const voluntariado = () => {
    return (
        <div id="voluntariado" className='flex flex-col w-full'>
            <h2 className='text-3xl lg:text-5xl text-center my-4 lg:my-8 font-bold'>Cómo ayudar</h2>
            <div className='bg-comunidad bg-center bg-no-repeat bg-cover h-[40vh] sm:h-[60vh]' />
            <h3 className='text-center text-2xl lg:text-3xl my-5 lg:my-8 font-bold'>Ser voluntario</h3>
            <div className='bg-verde2 h-auto mb-5 lg:mb-8 w-11/12 lg:w-2/6 mx-auto p-4 lg:p-6 rounded-xl flex flex-col'>

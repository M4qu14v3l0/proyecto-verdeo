...
const AyudaFull = () => {
    ...
    const handleScroll = () => {
        const element = document.getElementById("ayuda-full");
    ...
    return (
        <div className="hidden lg:flex flex-col h-auto pb-16 px-10">
            <div className="w-9/12 h-2/10 mt-8 flex mx-auto flex-col mb-12">
                ...
                <p className="font-botones text-center text-lg">Queremos que lo que difundimos y hacemos llegue a muchas más personas en todo el mundo. Por eso tu apoyo siendo nuestro embajador de las redes sociales y es importante en nuestra labor.</p>
                <p className="font-botones text-center text-lg mt-6">¡Habla de la naturaleza y comparte!</p>
            </div>

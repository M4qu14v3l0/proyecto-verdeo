...
const actividades = [
    {
        ...
        linkclass:"flex mx-auto mb-8 rounded-2xl bg-verde w-[232px] h-[40px] lg:w-6/12 lg:h-10 hover:bg-[#2F9D5F] transition-all duration-300 ease-in-out lg:mb-0"
    },
    {
        title: "PA",
        ...
        titleclass: "text-center text-blanco text-8xl font-bold font-titulos lg:mt-6",
        textClass: "font-botones text-blanco text-center m-auto text-sm",
        linkclass:"flex mx-auto rounded-2xl bg-rojo w-[232px] h-[40px] lg:w-6/12 lg:h-10 hover:bg-[#CF6842] transition-all duration-300 ease-in-out"
    },
]
...
const Hacemos = () => {
    return (
        <div className="w-11/12 flex mx-auto flex-col mt-6 lg:mt-10 lg:mb-10">
            <h2 className="text-center font-titulos font-bold text-xl mb-4 lg:mb-6 lg:text-3xl">Lo que hacemos</h2>
                ...
                {actividades.map((actividad) => (
                    <div className="w-full flex flex-col lg:items-center lg:mr-4 lg:min-h-[80vh] lg:mb-0 lg:w-[30vw]" key={actividad.title}>
                        <div className={actividad.divclass}>
                            ...
                            <p className="text-center text-blanco my-6 lg:my-8">{actividad.text}</p>
                        </div>

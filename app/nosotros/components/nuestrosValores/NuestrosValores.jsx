    ...
    <section id="valores" className="w-full">
        <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="h-[300px] sm:h-[400px] lg:h-[500px] xl:h-[600px] 2xl:h-[700px] w-full bg-[#F4B847] flex flex-col justify-center items-center">
              ...
              <p className="font-botones p-10">Ser fieles a nuestras responsabilidades e ideales como integrantes de este proyecto y ciudadanos, es algo que buscamos a través de lo que hacemos.

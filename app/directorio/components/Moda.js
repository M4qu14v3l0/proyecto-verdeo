...
const Moda = () => {
    ...
    const modas = empresas.filter(empresa => (empresa.rubro === "moda")).sort((a, b) => a.titulo.localeCompare(b.titulo));
    return (
        <div id='moda'>
            {modas.length >= 1 ? 

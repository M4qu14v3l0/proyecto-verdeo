    ...
    <section id="valores" className="w-full">
        <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="h-[300px] sm:h-[400px] lg:p-28 lg:h-[500px] xl:h-[600px] 2xl:h-[700px] w-full bg-[#F4B847] flex flex-col justify-center items-center">
              <h1 className="font-bold text-black text-3xl lg:text-4xl font-titulos">Nuestros valores</h1>
              <p className="font-botones p-5  lg:w-full text-xs md:text-base">Ser fieles a nuestras responsabilidades e ideales como integrantes de este proyecto y ciudadanos, es algo que buscamos a través de lo que hacemos.
